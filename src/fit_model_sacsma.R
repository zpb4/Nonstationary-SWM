...
#1) Prepare data
rf_err<-sma_predmat_hist[,'err 0']

rf_pred<-sma_predmat_hist[,rf_idx]
...
saveRDS(rf_err_corr,paste('fit_rev1/sacsma_rf-err-corr_cal_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
...
pred_mat<-sma_predmat_hist[,res_idx]
...
saveRDS(norm_vec,paste('fit_rev1/sacsma_norm-vec_hist_',sma_site,'.rds',sep=''))
...
saveRDS(pred_mat_zero,paste('fit_rev1/sacsma_pred-mat-zero_val_',sma_site,'.rds',sep=''))
...
saveRDS(dyn_res_coef,paste('fit_rev1/sacsma_dyn-res-coef_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
saveRDS(coef_mat,paste('fit_rev1/sacsma_dyn-res-coef-mat_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
saveRDS(param_out,paste('fit_rev1/sacsma_dyn-res-params_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
...
saveRDS(noise_pred_mat_zero,paste('fit_rev1/sacsma_noise-pred-mat-zero_val_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
...
saveRDS(noise_dyn_res_coef,paste('fit_rev1/sacsma_noise-dyn-res-coef_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
saveRDS(noise_coef_mat,paste('fit_rev1/sacsma_noise-dyn-res-coef-mat_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
saveRDS(noise_param_out,paste('fit_rev1/sacsma_noise-dyn-res-params_',sma_site,'_v-',vers,'_seed',seed,'.rds',sep=''))
}

saveRDS(ll_vec,paste('fit_rev1/sacsma_llvec_',sma_site,'_v-',vers,'.rds',sep=''))
saveRDS(noise_ll_vec,paste('fit_rev1/sacsma_noise-llvec_',sma_site,'_v-',vers,'.rds',sep=''))
