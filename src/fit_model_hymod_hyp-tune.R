...
rf_err_corr<-readRDS(paste('fit_rev1/rf-err-corr_hyp-tune_v-',vers,'.rds',sep=''))
...
saveRDS(dyn_res_coef,paste('fit_rev1/hymod_dyn-res-coef_',hym_site,'_v-',vers,'_seed',seed,'_hyp-tune.rds',sep=''))
saveRDS(coef_mat,paste('fit_rev1/hymod_dyn-res-coef-mat_',hym_site,'_v-',vers,'_seed',seed,'_hyp-tune.rds',sep=''))
saveRDS(param_out,paste('fit_rev1/hymod_dyn-res-params_',hym_site,'_v-',vers,'_seed',seed,'_hyp-tune.rds',sep=''))
...
saveRDS(noise_pred_mat_zero,paste('fit_rev1/hymod_noise-pred-mat-zero_val_',hym_site,'_v-',vers,'_seed',seed,'_hyp-tune.rds',sep=''))
...
saveRDS(noise_dyn_res_coef,paste('fit_rev1/hymod_noise-dyn-res-coef_',hym_site,'_v-',vers,'_seed',seed,'_hyp-tune.rds',sep=''))
saveRDS(noise_coef_mat,paste('fit_rev1/hymod_noise-dyn-res-coef-mat_',hym_site,'_v-',vers,'_seed',seed,'_hyp-tune.rds',sep=''))
saveRDS(noise_param_out,paste('fit_rev1/hymod_noise-dyn-res-params_',hym_site,'_v-',vers,'_seed',seed,'_hyp-tune.rds',sep=''))
