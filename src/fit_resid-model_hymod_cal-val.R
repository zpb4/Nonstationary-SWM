...
rg_db<-readRDS('fit/rf_corr_hymod_cal_87_97_def-ar1.rds')
...
db_cal<-predict(rg_db,data=predictor_mat_hist[idx_cal,1:11])$predictions
err_db_cal<-var_mat_hist[idx_cal,1]-db_cal

db_val<-predict(rg_db,data=predictor_mat_hist[idx_val,1:11])$predictions
...
saveRDS(par_val,'fit/hymod-resid-fit_mv-lin-ar_val_def-ar1.rds')
#saveRDS(par_cal,'fit/hymod-resid-fit_mv-lin-ar_cal_def-ar1.rds')
