...
gl_mle_val_neg5<-optimx(par=start,fn=GL_fun_mv_ar1_lin,sig_var=pred_scale_val,beta_var=pred_scale_val,xi_var=pred_scale_val,phi_var=pred_scale_val,et=err_db_val,
    lower = lb,upper = ub,#method = 'Rvmmin',
    control = list(maximize=T,all.methods=T,maxit=10000))
...
saveRDS(par_val,'fit/hymod-resid-fit_mv-lin-ar_val_def-full-hsked.rds')
#saveRDS(par_cal,'fit/hymod-resid-fit_mv-lin-ar_cal.rds')
